...
const Footer = () => {
    return (
        <footer className="px-4 divide-y bg-[#2f3542] text-white mt-20">
        <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
            <div className="lg:w-1/3">
                <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                    ...
                    <span className="self-center text-2xl font-semibold">BookishBliss</span>
                </a>
            </div>
        ...
        <div className="py-6 text-sm text-center dark:text-gray-600">© 2024 BookishBliss Company Co. All rights reserved.</div>
    </footer>
    );
};
