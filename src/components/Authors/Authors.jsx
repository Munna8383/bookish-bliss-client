...
const Authors = () => {
    return (
        <div className="w-full mt-20">
           ...
           <div className="max-w-xs p-6 rounded-md border-2 border-gray-500 dark:bg-gray-50 dark:text-gray-900 mx-5">
                <img src="https://i.ibb.co/j5SRj3p/22890669-6718801.jpg" alt="" className="object-cover object-center w-[300px] rounded-md h-80 dark:bg-gray-500" />
           ...
           <div className="max-w-xs p-6 rounded-md border-2 border-gray-500 dark:bg-gray-50 dark:text-gray-900  mx-5">
                <img src="https://i.ibb.co/n14dtcx/726px-Jane-Austen.jpg" alt="" className="object-cover object-center w-[300px]  rounded-md h-80 dark:bg-gray-500" />
                <div className="mt-6 mb-2">
           ...
           <div className="max-w-xs p-6 rounded-md border-2 border-gray-500 dark:bg-gray-50 dark:text-gray-900  mx-5">
                <img src="https://i.ibb.co/9sJJFYS/Kafka1906.jpg" alt="" className="object-cover object-center w-[300px]  rounded-md h-80 dark:bg-gray-500" />
                <div className="mt-6 mb-2">
           ...
           <div className="max-w-xs p-6 rounded-md border-2 border-gray-500 dark:bg-gray-50 dark:text-gray-900  mx-5">
                <img src="https://i.ibb.co/xFMDbvz/Carl-Van-Vechten-William-Faulkner.jpg" alt="" className="object-cover object-center w-[300px]  rounded-md h-80 dark:bg-gray-500" />
                <div className="mt-6 mb-2">
